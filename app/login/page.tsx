      ...
      <div className="w-full max-w-md bg-white rounded-xl shadow-lg border p-8">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground mt-1">
            {isLogin ? "Sign in to your account" : "Get started with On-Page Agent"}
          </p>
        </div>
        ...
        <button
          ...
          className="w-full border py-2.5 rounded-lg font-medium hover:bg-muted transition-colors flex items-center justify-center gap-2"
        >
